require.register "data/text", (exports, require, module) ->
  ...
  module.exports =
    ...
    ,
      name: "Europe"
      text: "Europe’s management of the pandemic varied substantially over time. The continent began as the single worst affected region globally, after a first wave of infections spread quickly between neighbouring countries. But much of Europe successfully turned the situation around — performing as well as the Asia-Pacific region for more than two months — as lockdowns took effect. Similarities in country trends were driven by high degrees of economic integration and lack of border closures across the continent. Despite the mid-year improvement, European countries’ management of the crisis slipped again towards the end of 2020 as a second wave took hold. Broadly, the worst affected countries in the region have been those in Western Europe with relatively internationally mobile and affluent populations, while many smaller Baltic countries and Mediterranean island states — such as Malta and Cyprus — were spared the worst of the crisis."
    ,
    ...
    politics: [
      ...
      text: "Many countries with an authoritarian system of government found initial success in supressing the pandemic before ultimately losing their early advantage. It may have been easier for authoritarian governments to rapidly impose initial lockdowns and to mobilise resources, but for many it proved difficult to sustain these measures and ensure social adherence in the longer term. The performance of authoritarian countries did improve towards the end of the examined period, but not to levels observed in the initial stages of the pandemic. Significant differences within this set of nations meant that the performance of authoritarian countries spanned a wide spectrum by the end of the examined period."
    ,
      name: "Hybrid regimes"
